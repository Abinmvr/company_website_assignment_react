...
const ApplyForm=()=>{
    ...
    const experience_needed = job_data.by_id.experience_in_years;
        ...
        if((name!=='')&&(email!=='')&&(job_id!=='')&&(experience!=='')&&(resume!=='')){
            ...
            if(validator.isEmail(email)){
                ...
                {headers:{
                    ...
                    if(status===true){
                            toast.success('Applied successfully !',{position:toast.POSITION.TOP_CENTER});
            ...
            }  else{  setError("Ineligible,Experience too low");}
        }else{
    ...
    const handleResume = (event:any) =>setResume(event.target.files[0]);
    return(
